...
// module.exports.mines_found = Minesweeper.this.minesFound;
// module.exports.moves_made = movesMade;
    ...
    constructor(opts = {}) {
      ...
      this,
      {
        ...
        options: {
          ...
          mines: 25 //number of mines in the grid
        } },
